...
static TpThreadInfo *tp_add_thread(TpThreadPool *pTp, process_job proc_fun, void *job, void *job1, int job2);
 ...
 * return:
 */
int tp_process_job(TpThreadPool *pTp, process_job proc_fun, void *arg, void *arg1, int arg2) {
	TpThreadInfo *pThi ;
	...
	if(pThi){
		...
		if(!(pThi = tp_add_thread(pTp, proc_fun, arg, arg1, arg2))){
 ...
 */
static TpThreadInfo *tp_add_thread(TpThreadPool *pTp, process_job proc_fun, void *arg, void *arg1, int arg2) {
	int err;
	...
	new_thread->arg = arg;
	new_thread->arg1 = arg1;
	new_thread->arg2 = arg2;
...
static void *tp_work_thread(void *arg) {
	...
	while (!(pTp->stop_flag)) {
		...
		if(pTinfo->proc_fun){
			...
			pTinfo->proc_fun(pTinfo->arg, pTinfo->arg1, pTinfo->arg2);
