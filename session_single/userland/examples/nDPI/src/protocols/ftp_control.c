...
//       flow->packet.packet_ftp_rr_direction = 0x0A;  //edit by daigang;20140726;0x0A is request;
...
//	  flow->packet.packet_ftp_rr_direction = 0x05;  //edit by daigang;20140726;0x05 is response;
