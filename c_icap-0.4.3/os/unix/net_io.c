...
#ifdef USE_IPV6
    if ((fd = icap_init_server_ipv6(address, port, protocol_family, secs_to_linger)) != CI_SOCKET_ERROR)
        return fd;
    ci_debug_printf(1, "WARNING! Error binding to an ipv6 address. Trying ipv4...\n");
#endif
